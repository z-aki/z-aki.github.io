...
```js show_lines="1:10"
---8<--- "docs/tampermonkey/upd_y/India Post Captcha bypass consignment search and autofill consignment from URL.user.js::100"
```
<!-- more -->
---8<--- "docs/tampermonkey/warning.txt"
```js
---8<--- "docs/tampermonkey/upd_y/India Post Captcha bypass consignment search and autofill consignment from URL.user.js:1:"
```
